      ...
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        {(study.services || study.client || study.duration) && (
            <ScrollRevealWrapper delay={150} className="mb-8 md:mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 bg-muted rounded-lg shadow">
                    {study.client && (
                        <div>
            ...
            <ScrollRevealWrapper delay={250} className="mb-8 md:mb-12">
                ...
                <ul className="space-y-3">
                    {study.results.map((result, index) => (
                        <li key={index} className="flex items-start p-4 bg-card border border-border rounded-lg shadow-sm">
        ...
        {/* Testimonial */}
        {study.testimonial && (
             <ScrollRevealWrapper delay={300} className="mb-8 md:mb-12 p-6 bg-muted rounded-lg shadow">
                <blockquote className="relative">
                    <svg className="absolute top-0 left-0 transform -translate-x-2 -translate-y-2 h-8 w-8 text-primary/30" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
                        <path d="M9.333 7C6.94 7 5 8.94 5 11.333V18h contexto4.667v-4.667h2.333V11.333C12 8.94 10.06 7 7.667 7zM23.333 7C20.94 7 19 8.94 19 11.333V18h4.667v-4.667h2.333V11.333C26 8.94 24.06 7 21.667 7z"/>
                    </svg>
